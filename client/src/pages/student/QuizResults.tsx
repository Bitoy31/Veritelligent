...
const QuizResults: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Get quiz data
        const quizResponse = await fetch(`https://api.veritelligent.fun/api/quiz/${quizId}`);
        ...
        if (location.state?.result) {
          ...
          const resultResponse = await fetch(`https://api.veritelligent.fun/api/quiz/${quizId}/result/${user._id}`);
