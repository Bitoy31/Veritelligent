...
const BuzzerBattleJoin: React.FC = () => {
  ...
  const handleCodeSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      navigate(`/student/buzzer-battle/${roomCode.trim().toUpperCase()}`);
    } catch (err) {
              ...
              <form onSubmit={handleCodeSubmit} className="code-entry">
                ...
                <button type="submit" disabled={joining}>
                  {joining ? (
                    ...
                    <>
                      <i className="fas fa-sign-in-alt"></i> Join Buzzer Battle
                    </>
                  )}
                </button>
              </form>
...
export default BuzzerBattleJoin;
