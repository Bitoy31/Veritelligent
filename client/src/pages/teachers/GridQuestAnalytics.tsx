...
const GridQuestAnalytics: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        ...
        const response = await fetch(`https://api.veritelligent.fun/api/gridquest/sessions/${sessionId}/analytics`);
  ...
  const handleExport = async () => {
    try {
      ...
      const response = await fetch(`https://api.veritelligent.fun/api/gridquest/sessions/${sessionId}/export`);
