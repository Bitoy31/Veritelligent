...
const BuzzerBattleAnalytics: React.FC = () => {
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      try {
        const response = await fetch(`https://api.veritelligent.fun/api/buzzerbattle/sessions/${sessionId}/analytics`);
  ...
  const handleExport = async () => {
    try {
      const response = await fetch(`https://api.veritelligent.fun/api/buzzerbattle/sessions/${sessionId}/export`);
