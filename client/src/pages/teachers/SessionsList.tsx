...
const SessionsList: React.FC = () => {
    ...
    const fetchTasks = async () => {
      try {
        ...
        try {
          ...
          const response = await fetch('https://api.veritelligent.fun/api/quiz');
          if (response.ok) {
        ...
        try {
          ...
          const response = await fetch(`https://api.veritelligent.fun/api/gridquest/tasks?teacherId=${user._id}`);
          if (response.ok) {
        ...
        try {
          ...
          const response = await fetch(`https://api.veritelligent.fun/api/buzzerbattle/tasks?teacherId=${user._id}`);
          if (response.ok) {
  ...
  const fetchSessions = async () => {
      try {
        ...
        const response = await fetch(`https://api.veritelligent.fun/api/analytics/sessions?teacherId=${user._id}`);
        if (!response.ok) {
  ...
  const handleBulkDeleteConfirm = async () => {
    ...
    try {
      const response = await fetch('https://api.veritelligent.fun/api/analytics/sessions/bulk', {
        method: 'DELETE',
        headers: {
                      ...
                      <button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            const res = await fetch(`https://api.veritelligent.fun/api/analytics/sessions/${sessionKey}`, { method: 'DELETE' });
                            if (!res.ok) {
